                    ...
                    <ul className="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0 items-center">
                        <li>
                          ...
                          <Link href="/add">
                            ...
                            className="block py-2 pr-4 pl-3 text-white rounded bg-blue-700 md:bg-transparent md:text-blue-700 md:p-0" aria-current="page">
                              Add Sponsorship
                            </a>
                          </Link>
                        </li>
                        {isConnected && (
                          <>
                            ...
                            <li>
                              <Link href="/manage">
                                <a className="block py-2 pr-4 pl-3 text-white rounded bg-blue-700 md:bg-transparent md:text-blue-700 md:p-0" aria-current="page">
                                  Your Sponsorships
                                </a>
                              </Link>
                            </li>
