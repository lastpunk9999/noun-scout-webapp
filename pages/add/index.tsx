...
const Add: NextPage = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="flex flex-col p-10 h-screen justify-center gap-10 items-center sticky top-0">
        <div className="flex flex-col gap-5">
          <h1 className="text-3xl font-bold text-center font-serif">
            Sponsor a Noun trait
          </h1>
          <div className="flex p-1 justify-center gap-5 items-center rounded-lg justify-self-end">
            {steps.map((step, i) => {
              return (
                <button
                  className={cx(
      ...
      {/* Stepper */}
      <div className="max-w-4xl mx-auto border border-slate-200 border-top-0 bg-white p-10">
        {/* Step wrapper */}
        {currentStep === 0 && (
          <>
            <AddTrait
